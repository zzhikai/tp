...
import seedu.linkedout.model.person.UniquePersonList;
...
public class AddressBook implements ReadOnlyAddressBook {
    ...
    /**
     * Adds a person to the linkedout book.
     * The person must not already exist in the linkedout book.
     */
     ...
     * The person identity of {@code editedPerson} must not be the same as another existing person in the linkedout book.
     */
