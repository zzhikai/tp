...
public class AddCommandParser implements Parser<AddCommand> {
    ...
    public AddCommand parse(String args) throws ParseException {
        ...
        if (!arePrefixesPresent(argMultimap, PREFIX_NAME, PREFIX_STAGE, PREFIX_PHONE, PREFIX_EMAIL)
        ...
        Applicant applicant = new Applicant(name, phone, email, stage, skillList);
