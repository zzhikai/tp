...
| `* *`    | Recruiter that deals with large amounts of data | sort the applicant in the system by name                                  | easily view on applicants in alphabetical order                   |
| `* *`    | Recruiter that deals with large amounts of data | sort the applicant in the system by job applied                           | easily view on job applied in alphabetical order                  |
